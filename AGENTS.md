...
- Workspace ID: `d09d77e1-68a0-4d55-b689-0adc0e872e00`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/d09d77e1-68a0-4d55-b689-0adc0e872e00.
...
2. `npx ngodingpakeai connect --workspace d09d77e1-68a0-4d55-b689-0adc0e872e00 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/d09d77e1-68a0-4d55-b689-0adc0e872e00. Only pass on links the CLI actually printed — never assemble one from an id yourself.
