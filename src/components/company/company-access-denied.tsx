...
type CompanyAccessDeniedProps = {
  role: UserRole;
};

export function CompanyAccessDenied({ role }: CompanyAccessDeniedProps) {
  return (
    <main
      id="konten-utama"
      tabIndex={-1}
    ...
    >
      ...
      <p className="text-muted-foreground mt-3 text-base leading-7" role="status">
        Halaman ini hanya untuk akun perusahaan. Saat ini Anda masuk sebagai{" "}
