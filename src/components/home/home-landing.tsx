...
const IMPACT_STATS = [
  { value: "Profil", label: "Pencari kerja dilengkapi sebelum disalurkan" },
  { value: "Tinjauan", label: "Admin meninjau kebutuhan perusahaan" },
  { value: "Lowongan", label: "Tayang setelah kebutuhan disetujui" },
  { value: "Penyaluran", label: "Kandidat dihubungkan ke perusahaan" },
] as const;
...
const TESTIMONIALS = [
  {
    quote:
      "Profil dilengkapi dulu, lalu admin yang meninjau dan menyalurkan. Pencari kerja tidak perlu menebak proses lamaran sendirian.",
    name: "Pencari kerja",
    role: "Penyaluran setelah profil lengkap",
  },
  {
    quote:
      "Kebutuhan karyawan ditinjau admin sebelum tampil sebagai lowongan. Perusahaan mendapat kandidat yang sudah disaring.",
    name: "Perusahaan",
    role: "Lowongan tayang setelah disetujui",
  },
  {
    quote:
      "Pelatihan dan CV membantu memperjelas keahlian, agar penyaluran ke tempat kerja ramah disabilitas lebih tepat.",
    name: "Persiapan kerja",
    role: "Pelatihan, profil, dan CV",
  },
] as const;
