    ...
    >
      ...
      <header className="mb-8 max-w-3xl">
        ...
        <p className="text-muted-foreground mt-3 text-base leading-7">
          Tinjau data perusahaan dan kebutuhan karyawan sebelum menyalurkan
          kandidat. Setujui kebutuhan di halaman tinjauan agar lowongan tampil.
        </p>
        <PageActions>
          <PageActionLink href="/admin/kebutuhan" variant="default">
            Tinjau kebutuhan
          </PageActionLink>
        </PageActions>
      </header>
