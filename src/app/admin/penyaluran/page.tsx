...
import { uniqueSeekerCities } from "@/lib/placements/seeker-filters";
...
export default async function AdminPlacementPage({
  ...
  const cities = uniqueSeekerCities(MOCK_JOB_SEEKERS);
    ...
    >
      <header className="mb-8 max-w-3xl">
        ...
        <p className="text-muted-foreground mt-3 text-base leading-7">
          ...
          menyalurkan kandidat ke perusahaan yang membuka lowongan sesuai.
        </p>
        <PageActions>
      ...
      <PlacementOverview data={data} cities={cities} />
    </main>
  );
}
