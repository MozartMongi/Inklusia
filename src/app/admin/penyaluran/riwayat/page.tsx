...
import { uniquePlacementCompanies } from "@/lib/placements/history-filters";
...
export const metadata: Metadata = {
  ...
  description:
    "Riwayat lengkap penyaluran kandidat oleh admin, dengan saringan data tiruan.",
};
...
export default async function AdminPlacementHistoryPage({
  ...
  const { placements, filters } = await fetchAdminPlacementHistory(params);
  const companies = uniquePlacementCompanies(MOCK_PLACEMENTS);
