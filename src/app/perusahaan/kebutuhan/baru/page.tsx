...
export const metadata: Metadata = {
  title: "Buat inquiry karyawan",
  description:
    "Ajukan kebutuhan karyawan disabilitas. Admin yang akan menyalurkan kandidat.",
};

export default async function CreateInquiryPage() {
    ...
    >
      ...
      <header className="mb-8">
        ...
        <p className="text-muted-foreground mt-3 text-base leading-7">
          Jelaskan posisi yang dibutuhkan. Setelah dikirim, kebutuhan menunggu
          persetujuan admin sebelum tampil sebagai lowongan publik.
        </p>
      </header>
      <InquiryForm companyName={profile.name} />
    </main>
  );
}
