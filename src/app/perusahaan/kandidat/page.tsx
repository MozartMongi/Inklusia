...
import { fetchCompanyReceivedCandidates } from "@/lib/api/placements";
    ...
    >
      <header className="mb-8">
        ...
        <p className="text-muted-foreground mt-3 text-base leading-7">
          {profile.name} menerima kandidat dari admin. Perusahaan tidak
          menerima lamaran langsung dari pencari kerja.
        </p>
        <PageActions>
